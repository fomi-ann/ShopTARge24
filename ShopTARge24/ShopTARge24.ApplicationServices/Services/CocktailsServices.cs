...
namespace ShopTARge24.ApplicationServices.Services
{
    ...
    {
        public async Task<DrinkDto> GetCocktail(DrinkDto dto)
        {
            string url;
            ...
            if (string.IsNullOrWhiteSpace(dto.strDrink))
                ...
                url = $"https://www.thecocktaildb.com/api/json/v1/1/search.php?s={dto.strDrink}";
            ...
            using (WebClient client = new WebClient())
                ...
                if (root?.Drinks == null || !root.Drinks.Any())
                {
                    return null;
                }
